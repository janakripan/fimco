...
function SpecRow({ label, value }) {
  return (
    <div className="flex items-center justify-between py-3 border-b border-primary/8 last:border-0">
      <span className="font-montserrat text-xs text-primary/50 uppercase tracking-widest">
        {label}
      </span>
...
const ICON_PATH = {
  ...
  security:
    "M9 12l2 2 4-4M12 2l7 4v6c0 4.97-3.07 9.63-7 11C8.07 21.63 5 16.97 5 12V6l7-4z",
...
export default function PropertyDetailClient({ property }) {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="w-full bg-white pt-24 pb-8 max-w-7xl mx-auto px-4 md:px-10 lg:px-16 overflow-visible">
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 text-primary/50 font-montserrat text-[10px] sm:text-xs tracking-wider flex-wrap mb-4">
          <TransitionLink
            href="/"
            className="hover:text-accent transition-colors underline decoration-primary/20 underline-offset-4"
          >
            Back to search
          </TransitionLink>
          ...
          <span className="text-primary/70">
            {property.shortDesc.split(" | ")[0]}
          </span>
        </div>

        {/* --- MOBILE ONLY SLIDER --- */}
        <div className="flex md:hidden gap-4 overflow-x-auto hide-scrollbar snap-x snap-mandatory pb-4 -mx-4 px-4">
          {(property.images || []).map((src, i) => (
            <div
              key={i}
              className="relative w-[85%] sm:w-[75%] shrink-0 h-[45vh] min-h-[350px] rounded-2xl overflow-hidden snap-center shadow-md"
            >
              <Image
                src={src}
              ...
              {i === 0 && (
                <>
                  <div className="absolute top-4 left-4 z-10">
                    <span
                      className={`px-4 py-2 font-montserrat text-[10px] uppercase tracking-widest font-bold rounded-sm shadow-md ${property.status === "Off-Plan" ? "bg-[#D4AF6A] text-white" : "bg-emerald-500 text-white"}`}
                    >
                      {property.status}{" "}
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center gap-2">
                    <div className="flex items-center gap-2 bg-white text-primary rounded-full px-4 py-2 shadow-md">
                      ...
                      <span className="font-montserrat text-[11px] font-bold text-primary/80">
        ...
        <div className="hidden md:flex flex-row gap-4 h-[60vh] min-h-[350px]">
          ...
          >
            ...
            <div className="absolute top-6 left-6 z-10">
              <span
                className={`px-5 py-2.5 font-montserrat text-xs uppercase tracking-widest font-bold rounded-sm shadow-lg ${property.status === "Off-Plan" ? "bg-[#D4AF6A] text-white" : "bg-emerald-500 text-white"}`}
              >
            ...
            <div className="absolute bottom-6 left-6 flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2 bg-white text-primary rounded-full px-5 py-2.5 cursor-pointer shadow-md hover:bg-gray-100 transition-colors">
                ...
                <span className="font-montserrat text-xs font-bold text-primary/80">
                  {property.photoCount} photos
                </span>
              </div>
              <div className="flex items-center gap-2 bg-white text-primary rounded-full px-5 py-2.5 cursor-pointer shadow-md hover:bg-gray-100 transition-colors">
            ...
            <div className="absolute bottom-6 right-6 w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-lg">
              <span className="text-white font-oswald text-3xl font-bold">
                &amp;
              </span>
            </div>
          </motion.div>
          ...
          <div className="hidden md:flex flex-col w-[35%] gap-4">
            {thumbs.map((src, i) => (
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 transition-opacity duration-300 ${activeImg === i + 1 ? "bg-accent/20" : "bg-black/10 group-hover:bg-transparent"}`}
                />
      ...
      {/* ═══ PRICE HEADER ════════════════════════════════════════════════════ */}
      <section className="w-full bg-white border-b border-primary/10 overflow-hidden sm:overflow-visible">
        <div className="w-full max-w-7xl mx-auto px-4 md:px-16 py-8 flex flex-col md:flex-row md:items-start justify-between gap-6">
          <div className="flex flex-col gap-5">
            ...
            {property.developer && (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="font-montserrat text-[9px] uppercase tracking-[0.2em] text-primary/40">
                    Developer
                  </span>
            ...
            >
              <p className="font-montserrat text-primary/40 text-[10px] uppercase tracking-[0.35em] mb-2">
                {property.community} · {property.building}
              </p>
              <h1 className="text-3xl md:text-4xl font-montserrat font-bold text-primary tracking-tight mb-4">
                {property.title || property.building}
              </h1>
              <div className="flex items-end gap-3">
                <p className="text-4xl md:text-5xl font-oswald font-bold text-accent tracking-tight">
                  {property.price}
                </p>
                {property.pricePerSqft && (
                  <span className="font-montserrat text-sm text-primary/40 mb-1.5">
                    {property.pricePerSqft}
                  </span>
                )}
              </div>
            ...
            >
              {[
                {
                  label: getBedroomDisplay(),
                  path: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6",
                },
                {
                  label: getBathroomDisplay(),
                ...
                },
                {
                  ...
                  path: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1",
                },
              ].map((s) => (
                <div
                  key={s.label}
            ...
            {property.tags && (
              ...
              >
                {property.tags.split(" | ").map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-accent/10 text-accent border border-accent/20 font-montserrat text-[9px] uppercase tracking-[0.25em] font-bold rounded-full"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="flex flex-col items-end gap-4 shrink-0">
            {property.handoverDate && (
              <div className="text-right">
                <p className="font-montserrat text-[10px] uppercase tracking-widest text-primary/40">
                  Expected Handover
                </p>
            ...
            {property.paymentPlan && (
              <div className="text-right">
                ...
                <p className="font-montserrat text-sm font-bold text-accent">
                  {property.paymentPlan}
                </p>
              </div>
            )}
      ...
      {/* ═══ TWO-COLUMN BODY ══════════════════════════════════════════════════ */}
      <div className="w-full max-w-7xl mx-auto px-4 md:px-16 py-16 flex flex-col lg:flex-row gap-12 lg:gap-16 items-start relative">
        {/* ── LEFT ────────────────────────────────────────────────────── */}
        <div className="flex-1 min-w-0 w-full max-w-full overflow-hidden sm:overflow-visible flex flex-col gap-16">
          {/* Description */}
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              {visible.map((p, i) => (
                <p
                  key={i}
                  className="font-montserrat text-[15px] text-primary/65 leading-[1.85]"
                >
                  {p}
                </p>
              ))}
              ...
              <div className="flex flex-col gap-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-[#D4AF6A]/5 border border-[#D4AF6A]/20 p-5 rounded-sm flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-montserrat text-[10px] uppercase tracking-widest text-[#0E2A47]/50 mb-1">
                        Projected ROI
                      </p>
                      <p className="font-oswald text-xl font-bold text-[#0E2A47]">
                        {property.investmentPotential.roi}
                      </p>
                    </div>
                  </div>
                  <div className="bg-[#0E2A47]/5 border border-[#0E2A47]/10 p-5 rounded-sm flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-oswald text-xl font-bold text-[#0E2A47]">
                        {property.investmentPotential.goldenVisa}
                      </p>
                    </div>
                  </div>
                </div>
                {property.investmentPotential.summary && (
                  <p className="font-montserrat text-[15px] text-[#0E2A47]/65 leading-[1.85]">
                    {property.investmentPotential.summary}
                  </p>
                )}
                {property.investmentPotential.perks?.length > 0 && (
                  <ul className="flex flex-col gap-3">
                    {property.investmentPotential.perks.map((p, i) => (
                      <li
                        key={i}
                        className="flex items-start gap-3 font-montserrat text-sm text-[#0E2A47]/70"
                      >
                        <svg
                          className="w-5 h-5 text-[#D4AF6A] shrink-0 mt-0.5"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          strokeWidth="2"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {property.amenities.map((a, i) => (
                  ...
                  >
                    ...
                    <span className="font-montserrat text-xs text-primary/70 font-medium leading-tight">
                      {a.label}
                    </span>
                  </motion.div>
                ))}
                  ...
                  <table className="w-full text-left border-collapse min-w-[500px]">
                    <thead>
                      <tr className="bg-primary/5 border-b border-primary/10">
                        <th className="py-4 px-6 font-montserrat text-[10px] uppercase tracking-widest text-primary/50 font-bold whitespace-nowrap">
                          Unit Type
                        </th>
                        <th className="py-4 px-6 font-montserrat text-[10px] uppercase tracking-widest text-primary/50 font-bold whitespace-nowrap">
                          Size Range
                        </th>
                        <th className="py-4 px-6 font-montserrat text-[10px] uppercase tracking-widest text-primary/50 font-bold whitespace-nowrap text-right">
                          Starting Price
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {property.unitTypes.map((unit, i) => (
                        <tr
                          key={i}
                          className="border-b border-primary/5 hover:bg-accent/5 transition-colors group"
                        >
                          <td className="py-4 px-6 font-montserrat text-sm font-bold text-primary group-hover:text-accent transition-colors">
                            {unit.type}
                          </td>
                          <td className="py-4 px-6 font-montserrat text-sm text-primary/70">
                            {unit.size}
                          </td>
                          <td className="py-4 px-6 font-oswald text-lg font-bold text-accent text-right">
                            {unit.price}
                          </td>
                        </tr>
                      ))}
          ...
          {property.paymentPlanBreakdown?.length > 0 && (
            ...
            >
              ...
              <div className="bg-primary border border-primary/20 rounded-sm p-4 sm:p-6 overflow-hidden relative shadow-lg">
                <div
                  ...
                  {property.paymentPlanBreakdown.map((plan, i) => (
                    <button
                      ...
                      className={`shrink-0 px-5 py-2.5 rounded-sm font-montserrat text-xs tracking-wider transition-all duration-300 font-bold ${
                        activeTab === i
                          ? "bg-accent text-primary shadow-[0_0_15px_rgba(212,175,106,0.3)]"
                ...
                <div className="relative z-10 p-6 bg-white/5 border border-white/10 rounded-sm">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                      <p className="font-montserrat text-[10px] uppercase tracking-widest text-[#D4AF6A]/80 mb-2">
                        Milestone
                      </p>
                      <p className="font-oswald text-2xl md:text-3xl text-white tracking-tight">
                        {property.paymentPlanBreakdown[activeTab].milestone}
                      </p>
                    </div>
                    <div className="md:text-right border-t md:border-t-0 md:border-l border-white/10 pt-4 md:pt-0 md:pl-6">
                      <p className="font-montserrat text-[10px] uppercase tracking-widest text-white/40 mb-2">
                        Estimated Date
                      </p>
                      <p className="font-montserrat text-sm font-bold text-white/90 bg-white/10 px-4 py-2 rounded-sm inline-block">
                        {property.paymentPlanBreakdown[activeTab].date}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {property.floorPlanImages.map((img, i) => (
                  <div
                    key={i}
                    className="relative h-64 rounded-sm overflow-hidden border border-primary/10 group cursor-pointer"
                  >
                    <Image
                      src={img}
                      alt={`Floor plan ${i + 1}`}
            ...
            <div className="relative overflow-hidden border border-primary/10 h-64 bg-primary/3 flex items-center justify-center rounded-sm group">
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <p className="font-montserrat text-base font-bold text-primary">
                    {property.building}
                  </p>
                  <p className="font-montserrat text-sm text-primary/50">
          ...
          >
            ...
            <div className="bg-accent/5 border border-accent/20 rounded-sm p-4 sm:p-8">
              <div className="w-full max-w-2xl">
                <h3 className="font-oswald text-3xl font-bold text-primary mb-3">
                  Get Exclusive Property Updates
                </h3>
                <p className="font-montserrat text-sm text-primary/60 mb-6">
                  Be the first to receive floor plans, pricing updates, and
                  payment options for {property.title || property.building}. Our
                ...
                {leadFormSubmitted ? (
                  <div className="bg-emerald-50 border border-emerald-200 rounded-sm p-6 flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-montserrat text-sm font-bold text-emerald-900">
                        Thank you for your interest!
                      </p>
                      <p className="font-montserrat text-xs text-emerald-700 mt-1">
                  ...
                  >
                    <input
                      ...
                      className="w-full px-5 py-3 border border-primary/15 rounded-sm font-montserrat text-sm focus:outline-none focus:border-accent bg-white"
                    />
                    <input
                      required
                      type="email"
                    ...
                    <button
                      type="submit"
                      className="md:col-span-2 w-full py-4 bg-accent text-primary font-montserrat text-[10px] uppercase tracking-[0.3em] font-bold rounded-sm hover:shadow-lg transition-all duration-300"
                    >
                      Submit Enquiry
                    </button>
          ...
          {related.length > 0 && (
            ...
            >
              ...
              <div className="flex w-full gap-6 overflow-x-auto pb-4 -mx-4 px-4 hide-scrollbar">
                {related.map((r, i) => (
                  <TransitionLink key={r.id} href={`/property/${r.slug}`}>
                    ...
                    >
                      <div className="relative h-44 w-full overflow-hidden mb-4 rounded-sm">
                        ...
                        <span
                          className={`absolute top-3 right-3 px-3 py-1 rounded-full font-montserrat text-[9px] font-bold ${r.status === "Ready" ? "bg-emerald-500/90 text-white" : "bg-accent text-primary"}`}
                        >
                          {r.status}
                        </span>
                      </div>
                      <p className="font-oswald text-lg font-bold text-primary group-hover:text-accent transition-colors duration-300">
                        {r.price}
                      </p>
                      <p className="font-montserrat text-xs text-primary/55 mt-1 line-clamp-1">
                        {r.shortDesc}
                      </p>
        ...
        <div className="w-full lg:w-[360px] shrink-0 flex flex-col gap-5 sticky top-[100px] h-max z-10 self-start">
          ...
          >
            <div className="bg-primary p-6 relative overflow-hidden">
              ...
              />
              <p className="font-montserrat text-[9px] uppercase tracking-[0.45em] text-accent/80 mb-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-montserrat text-[10px] text-accent/70 mt-1.5">
            ...
            <div className="p-5 flex flex-col gap-3 bg-white">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a
                  href={`https://wa.me/${property.agent?.whatsapp}?text=${encodeURIComponent(`Hello, I am interested in ${property.title || property.building}`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            ...
            >
              <div>
                <p className="font-montserrat text-[9px] uppercase tracking-[0.35em] text-primary/45 mb-1.5">
                  Estimated Mortgage
                </p>
                <p className="font-oswald text-2xl font-bold text-primary">
                  AED {fmt(Math.round(monthly))}
                  <span className="text-sm font-montserrat font-normal text-primary/50">
                    {" "}
                    / mo
                  </span>
                </p>
              ...
              <svg
                className={`w-5 h-5 text-primary/40 transition-transform duration-300 shrink-0 ${calcOpen ? "rotate-180" : ""}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="1.5"
              ...
              {calcOpen && (
                ...
                >
                  <div className="p-5 flex flex-col gap-5 border-t border-primary/8">
                    <div>
                      <label className="font-montserrat text-[10px] uppercase tracking-widest text-primary/45 mb-2 block">
                        Property Price
                      </label>
                      <div className="px-4 py-3 bg-primary/5 rounded-sm font-oswald text-primary font-bold text-sm">
                        {property.price}
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between mb-2">
                        <label className="font-montserrat text-[10px] uppercase tracking-widest text-primary/45">
                          Down Payment
                        </label>
                        <span className="font-montserrat text-xs font-bold text-primary">
                          {downPct}% · AED{" "}
                          {fmt(
                            Math.round((property.priceNumeric * downPct) / 100),
                          )}
                        </span>
                      </div>
                      <input
                    ...
                    <p className="font-montserrat text-[10px] text-primary/30 leading-relaxed">
                      Estimate only. Subject to bank approval and prevailing
                      rates.
                    </p>
                  </div>
                </motion.div>
          ...
          {property.regulatory && (
            ...
            >
              <p className="font-montserrat text-[9px] uppercase tracking-[0.45em] text-accent font-bold mb-4">
                Regulatory Information
              </p>
              {[
                {
                  label: "Reference No.",
                  value: property.regulatory.reference,
                },
                { label: "Zone Name", value: property.regulatory.zoneName },
                {
                  label: "DLD Permit No.",
                  value: property.regulatory.dldPermitNumber,
                },
              ].map((r) => (
                <div
                  key={r.label}
                  className="flex justify-between items-center py-2.5 border-b border-primary/8 last:border-0"
                >
                  <span className="font-montserrat text-[10px] uppercase tracking-widest text-primary/40">
                    {r.label}
                  </span>
                  <span className="font-montserrat text-xs font-bold text-primary/80">
                    {r.value}
      ...
      <section className="relative w-full bg-primary overflow-hidden py-20 px-6 md:px-16">
        ...
        <div className="relative z-10 max-w-3xl">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-8 h-px bg-accent" />
            <span className="font-montserrat text-[9px] uppercase tracking-[0.45em] text-accent/80">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              ...
              className="px-8 py-4 border border-white/20 text-white font-montserrat text-[10px] uppercase tracking-[0.3em] font-bold rounded-full hover:border-[#D4AF6A] hover:text-[#D4AF6A] transition-colors duration-300"
              onMouseEnter={() => {
                setVariant("link");
                setSize(80);
                setText("");
            ...
            <button
              ...
              className="px-8 py-4 bg-white/5 border border-white/10 text-white font-montserrat text-[10px] uppercase tracking-[0.3em] font-bold rounded-full hover:bg-white hover:text-[#0E2A47] transition-colors duration-300"
              onMouseEnter={() => {
                setVariant("link");
                setSize(80);
                setText("");
        ...
        {enquireOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg bg-white rounded-sm shadow-2xl p-8 z-10"
            >
              <button
                onClick={() => setEnquireOpen(false)}
                className="absolute top-4 right-4 text-primary/40 hover:text-accent transition-colors"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
              ...
              <h3 className="font-oswald text-3xl font-bold text-primary mb-2">
                Register Your Interest
              </h3>
              <p className="font-montserrat text-sm text-primary/60 mb-6">
                Our team will get back to you shortly regarding{" "}
                {property.title || property.building}.
              </p>
              <form
              ...
              >
                <input
                  ...
                  type="text"
                  placeholder="Full Name"
                  className="w-full px-5 py-3 border border-primary/10 rounded-sm font-montserrat text-sm focus:outline-none focus:border-accent"
                />
                <input
                  required
                  type="email"
                ...
                <button
                  type="submit"
                  className="w-full py-4 mt-2 bg-primary text-white font-montserrat text-[10px] uppercase tracking-[0.3em] font-bold rounded-sm hover:bg-accent hover:text-primary transition-colors"
                >
                  Submit Enquiry
                </button>
              </form>
        ...
        {brochureOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="relative w-full max-w-lg bg-white rounded-sm shadow-2xl p-8 z-10 border-t-4 border-accent"
            >
              <button
                onClick={() => setBrochureOpen(false)}
                className="absolute top-4 right-4 text-primary/40 hover:text-accent transition-colors"
              ...
              <p className="font-montserrat text-sm text-primary/60 mb-6">
                Enter your details to download the comprehensive brochure and
                layout plans for {property.title || property.building}.
              </p>
              <form
                className="flex flex-col gap-4"
              ...
              >
                <input
                  ...
                  type="text"
                  placeholder="Full Name"
                  className="w-full px-5 py-3 border border-primary/10 rounded-sm font-montserrat text-sm focus:outline-none focus:border-accent bg-primary/5"
                />
                <input
                  required
                  type="email"
                ...
                <button
                  type="submit"
                  className="w-full py-4 mt-2 bg-accent text-primary font-montserrat text-[10px] uppercase tracking-[0.3em] font-bold rounded-sm hover:shadow-lg transition-shadow flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
