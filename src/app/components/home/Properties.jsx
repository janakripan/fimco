...
const PropertyCard = ({ property }) => {
  ...
  return (
    <motion.div
      ref={containerRef}
      style={{ opacity, y }}
      className={`w-full flex ${flexClass} group ${property.mt} ${property.maxWidth || ""} mb-16 md:mb-24`}
    >
      <div
  ...
  return (
    <>
      <section className="w-full bg-white py-24 md:py-48 px-6 md:px-16 lg:px-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start mb-40 gap-12 lg:gap-24 relative z-10">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-montserrat tracking-tight flex flex-row items-center gap-4 leading-[0.85]">
              ...
              <span className="capitalize" style={{ WebkitTextStroke: "2px #0E2A47", color: "transparent" }}>
                Properties
              </span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-x-16 lg:gap-x-44 justify-between border-b border-primary/10 pb-20">
          <div className="w-full md:w-[40%] flex flex-col pt-0">
            {leftItems.map((property) => (
              <PropertyCard key={property.id} property={property} />
            ))}
          </div>
          <div className="w-full md:w-[50%] flex flex-col pt-16 md:pt-24">
        ...
        {/* NEW CAPABILITY: Off-plan carousel block added *below* masonry grid inside the properties section! */}
        ...
        {/* View All Properties Link AND old Listing CTA Section - unchanged from before */}
